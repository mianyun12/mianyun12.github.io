...
const translation: Translation = {
    ...
    about: {
        ...
        readmeCardTitle: "Mianyun's Journey Through Mountains and Seas",
        readmeCardParagraph1: "“Mianyun” is a quiet coordinate I gave myself: a place to gather beneath the clouds, then keep setting out toward the mountains and seas. “A Journey Through Mountains and Seas” turns this site into an evolving travelogue—recording the code I write, the wrong turns I take, the works I finish, and the ideas still on their way.",
        readmeCardParagraph2: "These pages do not aim to offer perfect answers all at once. They simply keep each attempt, so that when I look back, I can still recognize how I traveled from a small cloud toward a wider world.",
